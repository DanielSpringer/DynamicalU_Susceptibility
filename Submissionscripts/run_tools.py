...
def fixed_UscUst(config, U_sc, U_st, w0_grid, w0_min, w0_max):
    ...
    for w0 in w0_grid:
        ...
        os.system(prompt)
        os.system("sbatch vsc_0768.slrm")
    ...
    for ust in U_st_grid:
        for usc in U_sc_grid:
            if ust-usc>=0:
                ...
                fileold = "NONE"
                v = 0
                # Use these to detect if there are folders with missing files/runs.
                oo1 = 0
                oo2 = 0
                for f in files:
                    # if "oo_1" in f:
                ...
                if oo2==0: 
                    ...
                    os.system("sbatch vsc_0096.slrm")
                    # os.system("sbatch vsc_0768.slrm")
                    # os.system("sbatch vsc_0384.slrm")
                os.chdir("../../")
